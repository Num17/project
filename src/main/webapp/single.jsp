	...
	<div class="wrap-body">
		<div id='cssmenu' class="align-center">
			<ul>
			   ...
			   <li class='active'><a href='${pageContext.request.contextPath}/single.jsp'><span>About</span></a></li>
			   <li class='last'><a href='${pageContext.request.contextPath}/contact.jsp'><span>Contacts</span></a></li>
			</ul>
		</div>
		<header class="">
			<div class="logo">
